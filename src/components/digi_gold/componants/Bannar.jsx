  ...
  return (
    <div className='bannar_image'>
        <div className='discription_details'>
            ...
            <p>Buy Swiston DigiGld online to save money, grow <br/> your wealth, and convert your gold into beautiful <br/>jewellery—whenever you want it. Guaranteed, no-hassles buyback.</p>
