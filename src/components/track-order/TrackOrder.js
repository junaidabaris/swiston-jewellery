...
function TrackOrder() {
  ...
  return (
    <>
      <Helmet>
        <title>Track Order | Fertilizer Multi Vendor</title>
        <meta
          name="keyword"
      ...
      <div className="trackDetail">
        <div className="container">
          <div className="row">
            ...
            {data?.getaOrderById && <div className="row orderdetails" id="pdfGen">
              <div className="bar-code">
                <div>
                  <h5> Customer Name : {data?.getaOrderById?.user?.firstname}  {data?.getaOrderById?.user?.lastname}</h5>
                  ...
                  <tbody>
                    {data?.delivery.map((item, i) => {
                      return <tr key={i}>
                        ...
                        <td>{item?.status}</td>
                        <td>
                          <img style={{ widows: "100px", height: "100px" }} src={item?.photo ? item?.photo.url : ''} />
                        </td>
                      </tr>
                    })}
