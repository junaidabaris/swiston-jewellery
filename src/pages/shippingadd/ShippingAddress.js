...
import "./shippadd.css"
import { ShippAddComp } from "../../components/shippingCompo/ShippAddComp";
        ...
        <div className="card container" style={{ margin: "10px auto" }}>
            ...
            <div className="card-body">
                <div className="col-lg-6 mx-auto">
                    <div onClick={handleShow2} className="border p-3 rounded mb-3 c-pointer text-center bg-light">
                ...
                <div className="row gutters-10">
                    {true && [
                        ...
                        return <ShippAddComp item={item} handleShow={handleShow} key={item._id} />
                    })}
            ...
            <Modal show={show} style={{ padding: "20px" }} ship='Shipping' onHide={handleClose}>
                <EditAddress handleClose={handleClose} ship='Shipping' type='shipping' />
            </Modal>
        </div>
    </div>
}
